...
import { Shield, Users, Settings, LogOut, Plus, Minus, Save, Image, Edit2, X, Upload, Loader2, BarChart3, HardDrive, Eye, FolderOpen, Search, UserX, UserCheck, Trash2, ExternalLink, Clock, Activity, ToggleLeft, ToggleRight, QrCode, Monitor, Link2, Trash, CreditCard, Crown, Star, Zap, DollarSign, CheckCircle, XCircle, AlertCircle, Sliders } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-zinc-900">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        {editingUserFeatures && (
          <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
            <div className="bg-zinc-800 rounded-lg max-w-lg w-full p-6" data-testid="user-features-modal">
              <div className="flex justify-between items-center mb-6">
                <div>
                  <h3 className="text-xl font-medium text-white">User Features</h3>
                  <p className="text-sm text-zinc-400 mt-1">
                    {photographers.find(p => p.id === editingUserFeatures)?.name || 'User'}
                  </p>
                </div>
                <button 
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 bg-zinc-700/50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-white font-medium text-sm">QR Share</h4>
                      <p className="text-xs text-zinc-400">Generate QR codes for galleries</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setUserFeatures(prev => ({ ...prev, qr_share: !prev.qr_share }))}
                    className={`p-1.5 rounded-lg transition-colors ${userFeatures.qr_share ? 'bg-green-600' : 'bg-zinc-600'}`}
                    data-testid="user-toggle-qr-share"
                  >
                    {userFeatures.qr_share ? (
                ...
                <div className="flex items-center justify-between p-3 bg-zinc-700/50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-white font-medium text-sm">Online Gallery</h4>
                      <p className="text-xs text-zinc-400">Public access to shared galleries</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setUserFeatures(prev => ({ ...prev, online_gallery: !prev.online_gallery }))}
                    className={`p-1.5 rounded-lg transition-colors ${userFeatures.online_gallery ? 'bg-green-600' : 'bg-zinc-600'}`}
                    data-testid="user-toggle-online-gallery"
                  >
                    {userFeatures.online_gallery ? (
                      <ToggleRight className="w-5 h-5 text-white" />
                    ) : (
                      <ToggleLeft className="w-5 h-5 text-zinc-400" />
                    )}
                ...
                <div className="flex items-center justify-between p-3 bg-zinc-700/50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-white font-medium text-sm">Display Mode</h4>
                      <p className="text-xs text-zinc-400">Slideshow and Live Collage</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setUserFeatures(prev => ({ ...prev, display_mode: !prev.display_mode }))}
                    className={`p-1.5 rounded-lg transition-colors ${userFeatures.display_mode ? 'bg-green-600' : 'bg-zinc-600'}`}
                    data-testid="user-toggle-display-mode"
                  >
                    {userFeatures.display_mode ? (
                      <ToggleRight className="w-5 h-5 text-white" />
                    ) : (
                      <ToggleLeft className="w-5 h-5 text-zinc-400" />
                    )}
                ...
                <div className="flex items-center justify-between p-3 bg-zinc-700/50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-white font-medium text-sm">Contributor Link</h4>
                      <p className="text-xs text-zinc-400">Upload links for collaborators</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setUserFeatures(prev => ({ ...prev, contributor_link: !prev.contributor_link }))}
                    className={`p-1.5 rounded-lg transition-colors ${userFeatures.contributor_link ? 'bg-green-600' : 'bg-zinc-600'}`}
                    data-testid="user-toggle-contributor-link"
                  >
                    {userFeatures.contributor_link ? (
                      <ToggleRight className="w-5 h-5 text-white" />
                    ) : (
                      <ToggleLeft className="w-5 h-5 text-zinc-400" />
                    )}
                ...
                <div className="flex items-center justify-between p-3 bg-zinc-700/50 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-white font-medium text-sm">Auto Delete (6 months)</h4>
                      <p className="text-xs text-zinc-400">Auto-delete inactive galleries</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setUserFeatures(prev => ({ ...prev, auto_delete_enabled: !prev.auto_delete_enabled }))}
                    className={`p-1.5 rounded-lg transition-colors ${userFeatures.auto_delete_enabled ? 'bg-green-600' : 'bg-zinc-600'}`}
                    data-testid="user-toggle-auto-delete"
                  >
                    {userFeatures.auto_delete_enabled ? (
                      <ToggleRight className="w-5 h-5 text-white" />
                    ) : (
                      <ToggleLeft className="w-5 h-5 text-zinc-400" />
                    )}
              ...
              <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-zinc-700">
                ...
                <button
                  ...
                  data-testid="save-user-features"
                >
                  <Save className="w-4 h-4" />
                  {savingUserFeatures ? 'Saving...' : 'Save Features'}
                </button>
              </div>
            </div>
          </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-zinc-700/50 rounded-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-white font-medium">QR Share</h3>
                      <p className="text-sm text-zinc-400">Allow photographers to generate QR codes for galleries</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setFeatureToggles(prev => ({ ...prev, qr_share: !prev.qr_share }))}
                    className={`p-2 rounded-lg transition-colors ${featureToggles.qr_share ? 'bg-green-600' : 'bg-zinc-600'}`}
                    data-testid="toggle-qr-share"
                  >
                    {featureToggles.qr_share ? (
                      <ToggleRight className="w-6 h-6 text-white" />
                    ) : (
                      <ToggleLeft className="w-6 h-6 text-zinc-400" />
                    )}
                ...
                <div className="flex items-center justify-between p-4 bg-zinc-700/50 rounded-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-white font-medium">Online Gallery</h3>
                      <p className="text-sm text-zinc-400">Allow public access to shared galleries</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setFeatureToggles(prev => ({ ...prev, online_gallery: !prev.online_gallery }))}
                    className={`p-2 rounded-lg transition-colors ${featureToggles.online_gallery ? 'bg-green-600' : 'bg-zinc-600'}`}
                    data-testid="toggle-online-gallery"
                  >
                    {featureToggles.online_gallery ? (
                      <ToggleRight className="w-6 h-6 text-white" />
                    ) : (
                      <ToggleLeft className="w-6 h-6 text-zinc-400" />
                    )}
                ...
                <div className="flex items-center justify-between p-4 bg-zinc-700/50 rounded-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-zinc-400">Slideshow and Live Collage display for viewing stations</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setFeatureToggles(prev => ({ ...prev, display_mode: !prev.display_mode }))}
                    className={`p-2 rounded-lg transition-colors ${featureToggles.display_mode ? 'bg-green-600' : 'bg-zinc-600'}`}
                    data-testid="toggle-display-mode"
                  >
                    {featureToggles.display_mode ? (
                      <ToggleRight className="w-6 h-6 text-white" />
                    ) : (
                      <ToggleLeft className="w-6 h-6 text-zinc-400" />
                    )}
                ...
                <div className="flex items-center justify-between p-4 bg-zinc-700/50 rounded-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-white font-medium">Contributor Link</h3>
                      <p className="text-sm text-zinc-400">Allow photographers to generate upload links for collaborators</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setFeatureToggles(prev => ({ ...prev, contributor_link: !prev.contributor_link }))}
                    className={`p-2 rounded-lg transition-colors ${featureToggles.contributor_link ? 'bg-green-600' : 'bg-zinc-600'}`}
                    data-testid="toggle-contributor-link"
                  >
                    {featureToggles.contributor_link ? (
                      <ToggleRight className="w-6 h-6 text-white" />
                    ) : (
                      <ToggleLeft className="w-6 h-6 text-zinc-400" />
                    )}
                ...
                <div className="flex items-center justify-between p-4 bg-zinc-700/50 rounded-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-white font-medium">Auto Delete (6 months)</h3>
                      <p className="text-sm text-zinc-400">Automatically delete galleries after 6 months of inactivity</p>
                    </div>
                  </div>
                  <button
                    onClick={() => setFeatureToggles(prev => ({ ...prev, auto_delete_enabled: !prev.auto_delete_enabled }))}
                    className={`p-2 rounded-lg transition-colors ${featureToggles.auto_delete_enabled ? 'bg-green-600' : 'bg-zinc-600'}`}
                    data-testid="toggle-auto-delete"
                  >
                    {featureToggles.auto_delete_enabled ? (
                      <ToggleRight className="w-6 h-6 text-white" />
                    ) : (
                      <ToggleLeft className="w-6 h-6 text-zinc-400" />
                    )}
              ...
              <div className="pt-4 border-t border-zinc-700">
                ...
                >
                  ...
                  {savingToggles ? 'Saving...' : 'Save Feature Settings'}
                </button>
              </div>
            </div>
          </div>
